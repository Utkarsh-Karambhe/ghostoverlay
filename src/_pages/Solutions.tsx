...
// [Integration] 1. Import your Typewriter component
  ...
  useEffect(() => {
    const updateDimensions = () => {
      if (contentRef.current) {
        // @ts-ignore - Assuming electronAPI exists on window
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative group">
                      ...
                      <div className="relative p-4 rounded-xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-white/10 text-sm text-slate-200 leading-relaxed shadow-lg backdrop-blur-sm">
                        {/* [Integration] 2. Applied Typewriter to Problem Statement */}
                        <Typewriter text={solution.problem_statement} speed={15} />
                      </div>
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-3 group">
                    <div className="flex items-center justify-between px-1">
                      ...
                      <button
                        ...
                        className={`text-[10px] flex items-center gap-2 px-3 py-1.5 rounded-lg transition-all duration-200 font-bold tracking-wide ${copied
                    ...
                    <div className="relative">
                      ...
                      <div className="relative rounded-xl overflow-hidden border border-cyan-500/20 bg-[#1e1e1e] shadow-2xl ring-1 ring-cyan-500/10">
                        ...
                        <div className="select-text cursor-text">
                          {/* [Integration] 3. Applied Typewriter with Render Prop for SyntaxHighlighter */}
                          {/* Using faster speed (2ms) for code so it doesn't take forever */}
                          <Typewriter text={solution.solution.code} speed={2}>
                            {(typedCode) => (
                              <SyntaxHighlighter
                                language="python"
                                style={vscDarkPlus}
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative flex gap-4 items-start px-4 py-4 rounded-xl bg-gradient-to-br from-slate-800/30 to-slate-900/30 border border-white/5 backdrop-blur-sm">
                      ...
                      <div className="space-y-2 flex-1">
                        ...
                        {/* [Integration] 4. Applied Typewriter to Reasoning */}
                        <div className="text-xs text-slate-300 italic leading-relaxed pl-1">
                          <Typewriter text={solution.reasoning} speed={15} />
                        </div>
                      </div>
                    </div>
                  </div>
